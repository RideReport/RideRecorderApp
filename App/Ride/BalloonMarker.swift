...
open class BalloonMarker: MarkerImage
{
    ...
    open override func refreshContent(entry: ChartDataEntry, highlight: Highlight)
    {
        ...
        let valueAttributes: [NSAttributedString.Key: Any] = [NSAttributedString.Key.foregroundColor: self.textColor, NSAttributedString.Key.font: self.valuesFont, NSAttributedString.Key.paragraphStyle: _paragraphStyle]
        let unitAttributes: [NSAttributedString.Key: Any] = [NSAttributedString.Key.foregroundColor: self.textColor, NSAttributedString.Key.font: self.font, NSAttributedString.Key.paragraphStyle: _paragraphStyle]
