...
class TripViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for viewController in self.children {
            if (viewController.isKind(of: MapViewController.self)) {
                ...
                NSLayoutConstraint(item: self.tripSummaryContainerView, attribute: .height, relatedBy: NSLayoutConstraint.Relation.equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: viewController.view.bounds.height).isActive = true
            }
        }
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name(rawValue: "TripSummaryViewDidChangeHeight"), object: nil, queue: nil) {[weak self] (notification : Notification) -> Void in
            ...
            guard !strongSelf.isUpdatingHeight else {
                return
            }
            strongSelf.isUpdatingHeight = true
            ...
            DispatchQueue.main.async {
                ...
                reallyStrongSelf.isUpdatingHeight = false
            }
        }
    }
