...
class SetupWatchActivitySyncingViewController : SetupChildViewController {
    ...
    override func viewDidLoad() {
        ...
        self.ringsContainerView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-0-[subview]-0-|", options: NSLayoutConstraint.FormatOptions(), metrics: nil, views: ["subview": ringsView]))
        self.ringsContainerView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[subview]-0-|", options: NSLayoutConstraint.FormatOptions(), metrics: nil, views: ["subview": ringsView]))
    ...
    @IBAction func cancel(_ sender: AnyObject) {
        let alertController = UIAlertController(title:nil, message: "Future rides will not be automatically saved to to your Apple Watch.", preferredStyle: UIAlertController.Style.actionSheet)
        alertController.addAction(UIAlertAction(title: "Cancel Saving", style: UIAlertAction.Style.destructive, handler: { (_) in
            self.didCancel = true
        ...
        alertController.addAction(UIAlertAction(title: "Keep Saving", style: UIAlertAction.Style.cancel, handler: nil))
