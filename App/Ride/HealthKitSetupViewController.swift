...
class HealthKitSetupViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 10.0, *) {
            if WatchManager.shared.paired {
                ...
                self.detailLabel.text = "Trying to fill your rings? Ride can automatically log your rides as exercise on your Apple Watch and the Health App."
            }
        }
    }
    ...
    @IBAction func sync(_ sender: AnyObject) {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(HealthKitSetupViewController.cancel))
