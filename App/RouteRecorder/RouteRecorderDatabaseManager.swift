...
class RouteRecorderDatabaseManager {
    ...
    class func startup(_ useInMemoryStore: Bool = false) {
        if (RouteRecorderDatabaseManager.shared == nil) {
            ...
            if RouteRecorderDatabaseManager.shared.managedObjectContext == nil {
                RouteRecorderDatabaseManager.shared.persistentStoreCoordinator = RouteRecorderDatabaseManager.shared.generatePSC()
                RouteRecorderDatabaseManager.shared.managedObjectContext = RouteRecorderDatabaseManager.shared.generateMOC()
            }
